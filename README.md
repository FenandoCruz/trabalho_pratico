...
| Tablet | 641 - 768px | Otimizado para tablets |
...
--primary-light: #3498db   /* Azul profissional */
--neutral-bg: #f5f7fa      /* Fundo neutro */
--neutral-text: #2d3748    /* Texto principal */
...
```bash
git clone https://github.com/FenandoCruz/trabalho_pratico.git
```

2. Abra o arquivo `curriculo.html` no navegador
...
```css
:root {
    --primary-dark: #2c3e50;    /* Mude a cor primária */
    --accent-blue: #3498db;     /* Mude a cor de destaque */
    /* ... outras variáveis */
}
```
